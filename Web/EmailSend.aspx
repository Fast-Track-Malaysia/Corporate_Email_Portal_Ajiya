<%@ Page Title="E-Mail Statement" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmailSend.aspx.cs" Inherits="Web.EmailSend" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" EnablePartialRendering="true" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            ...
            <div id="searchPanel">
                <div class="row">
                    <div class="col-md-2">
                        <asp:Label runat="server">Statement Date :</asp:Label>
                        <asp:TextBox ID="txtStatementDate" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                        <ajax:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtStatementDate" DaysModeTitleFormat="dd/MM/yyyy" Format="dd/MM/yyyy" TodaysDateFormat="dd/MM/yyyy"></ajax:CalendarExtender>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BalanceFC" HeaderText="Bal. FC" SortExpression="BalanceFC" DataFormatString="{0:#,##0.00;(#,##0.00);-}">
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
