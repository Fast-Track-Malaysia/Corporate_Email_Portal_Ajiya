...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="font_bold wrap">Reminder Sent Logs</h1>
    ...
    <asp:SqlDataSource CancelSelectOnNullParameter="true" ID="SqlDataSource" runat="server"
        SelectCommand="SELECT * FROM [FTS_fn_ReminderLogs] (@senddatefrStr, @senddatetoStr, @strFr, @strTo, @sendResult) T0 ORDER BY T0.SendDate DESC, T0.CardCode "
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Reminder Date" SortExpression="ReminderDate" ItemStyle-Width="150px">
                            <ItemTemplate>
                                <asp:Label ID="lblReminderDate" runat="server" Text='<%# Bind("ReminderDate") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Min. Amount" SortExpression="MinAmt" ItemStyle-Width="150px" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblMinAmt" runat="server" Text='<%# Bind("MinAmt") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Invoice Days From" SortExpression="InvDaysFrom" ItemStyle-Width="150px" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblInvDaysFrom" runat="server" Text='<%# Bind("InvDaysFrom") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Invoice Days To" SortExpression="InvDaysTo" ItemStyle-Width="150px" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblInvDaysTo" runat="server" Text='<%# Bind("InvDaysTo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Letter Type" SortExpression="LetterType" ItemStyle-Width="150px" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblLetterType" runat="server" Text='<%# Bind("LetterType") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
