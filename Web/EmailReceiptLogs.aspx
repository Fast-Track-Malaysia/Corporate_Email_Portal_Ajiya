<%@ Page Title="Receipt Sent Logs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmailReceiptLogs.aspx.cs" Inherits="Web.EmailReceiptLogs" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource CancelSelectOnNullParameter="true" ID="SqlDataSource" runat="server"
        SelectCommand="SELECT * FROM [FTS_fn_ReceiptLogs] (@senddatefrStr, @senddatetoStr, @datefrStr, @datetoStr, @strFr, @strTo, @sendResult) T0 ORDER BY T0.SendDate DESC, T0.DocEntry "
            ...
            <div id="searchPanel">
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <asp:TextBox ID="txtDateFr" runat="server" CssClass="form-control input-sm" placeholder="Receipt Date From"></asp:TextBox>
                    ...
                    <div class="col-md-2">
                        <asp:Label runat="server">&nbsp;</asp:Label>
                        <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control input-sm" placeholder="Receipt Date To"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="View" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:HyperLink ID="LinkView" runat="server" CssClass="btn btn-primary btn-xs"
                                    Target="_blank"
                                    NavigateUrl='<%# string.Format("~/PreviewReceipt.aspx?DocEntry={0}&SAPDocNo={1}&CardCode={2}&Mode=View", HttpUtility.UrlEncode(Eval("DocEntry").ToString()), HttpUtility.UrlEncode(Eval("DocNum").ToString()), HttpUtility.UrlEncode(Eval("CardCode").ToString())) %>'
                                    Text="Preview" />
                                <asp:HyperLink ID="LinkDownload" runat="server" CssClass="btn btn-primary btn-xs"
                                    NavigateUrl='<%# string.Format("~/PreviewReceipt.aspx?DocEntry={0}&SAPDocNo={1}&CardCode={2}&Mode=Download",HttpUtility.UrlEncode(Eval("DocEntry").ToString()), HttpUtility.UrlEncode(Eval("DocNum").ToString()), HttpUtility.UrlEncode(Eval("CardCode").ToString())) %>'
                                    Text="Download" />
                            </ItemTemplate>
